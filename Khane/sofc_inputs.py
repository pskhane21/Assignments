...
# Effective conductivities in the anode (Bruggeman correlation)
    sigma_el_eff = eps_el_an**(1 + n_brugg) * sigma_el
    sigma_io_eff = eps_io_an**(1 + n_brugg) * sigma_io
